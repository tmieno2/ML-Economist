...
We will see that a similar kind of minimization problem is solved in generalized random forest (GRF) in @sec-grf.

:::{.callout-tip}
Understanding what local regression is helps you understand how generalized random forest works in @sec-grf later.
:::
