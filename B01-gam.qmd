# Non-linear function estimation: Smoothing Splines and K-nearest neighbor regression
...
## Flexible representation using spline basis functions
...
## Flexible representation using K-nearest neighbor 
