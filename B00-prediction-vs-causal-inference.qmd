...
It is critical to understand the distinctions between <span style="color:blue"> prediction </span> and <span style="color:blue"> causal inference </span> for anybody who is interested in using machine learning (ML) methods. This is because a method designed to for former objective may not work well for the latter objective, and vice versa.
