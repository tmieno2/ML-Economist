...
In this chapter, we learn how to run Python codes from within R using the `reticulate` package. Its [package website](https://rstudio.github.io/reticulate/index.html) is very helpful and cover more topics than this chapter does.
