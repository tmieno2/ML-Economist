...
According to @eq-foc, optimal $x$ is $5$. @fig-opt-x shows the density plot of estimated optimal $x$ by KCV and SKCV. It seems like SKCV is a little more accurate than KCV. 
