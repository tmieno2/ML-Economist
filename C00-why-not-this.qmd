...
This approach actually has a name and it is called S-leaner. <span style="color:blue"> Indeed, lots of empirical studies in many scientific fields (not so much in economics) have used (and have been using) this approach for causal inference</span>. So, can't we just use this approach for every single causal inference task?
